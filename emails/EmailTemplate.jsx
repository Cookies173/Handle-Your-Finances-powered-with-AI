...
export default function EmailTemplate({ userName, data }){
  ...
  // const { userName, type, data } = PREVIEW_DATA;
    ...
    <Html>
      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          {data?.insights && (
            <Section style={styles.section}>
              <Heading style={styles.heading}>PennyPilot Insights</Heading>
          ...
          <Text style={styles.footer}>Thank you for using PennyPilot. Keep tracking your finances for better financial health!</Text>
        </Container>
      </Body>
    </Html>
  );
